 ...
 *==========================================================================*/
/*
 * \file /home/jpietrzyk/Own/Work/cidr24/src/intel_simd/modulo/tsl/include/generated/declarations/ls.hpp
 * \date 2023-07-22
 ...
 *
 */
#ifndef TUD_D2RG_TSL_HOME_JPIETRZYK_OWN_WORK_CIDR24_SRC_INTEL_SIMD_MODULO_TSL_INCLUDE_GENERATED_DECLARATIONS_LS_HPP
#define TUD_D2RG_TSL_HOME_JPIETRZYK_OWN_WORK_CIDR24_SRC_INTEL_SIMD_MODULO_TSL_INCLUDE_GENERATED_DECLARATIONS_LS_HPP
...
namespace tsl {
    ...
    template<
        ...
        ImplementationDegreeOfFreedom Idof = workaround
    >
    [[nodiscard]] TSL_FORCE_INLINE __attribute__((__aligned__(Vec::vector_alignment()))) std::array<typename Vec::base_type, Vec::vector_element_count()> to_array(
    ...
    template<
        ...
        ImplementationDegreeOfFreedom Idof = workaround
    >
    TSL_FORCE_INLINE void compress_store(
    ...
    namespace functors {
        // Definition of a preprocessor variable to detect overload ambiguity.
        #define TSL_FUNCTORS_EXPAND_LOAD_STRUCT_DEFINED
        // Forward declaration of implementation struct for TSL-primitive "expand_load".
        template<VectorProcessingStyle Vec, ImplementationDegreeOfFreedom Idof>
        struct expand_load{};
    }
    ...
    template<
        ...
        ImplementationDegreeOfFreedom Idof = workaround
    >
    [[nodiscard]] TSL_FORCE_INLINE typename Vec::register_type expand_load(
    ...
    namespace functors {
        // Definition of a preprocessor variable to detect overload ambiguity.
        #define TSL_FUNCTORS_LOAD_CONVERT_UP_STRUCT_DEFINED
        // Forward declaration of implementation struct for TSL-primitive "load_convert_up".
    ...
    >
    [[nodiscard]] TSL_FORCE_INLINE typename ToType::register_type load_convert_up(
...
#endif //TUD_D2RG_TSL_HOME_JPIETRZYK_OWN_WORK_CIDR24_SRC_INTEL_SIMD_MODULO_TSL_INCLUDE_GENERATED_DECLARATIONS_LS_HPP